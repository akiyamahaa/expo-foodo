...
const SLIDES = [
  {
    ...
    text: "🌍 Khám phá món ngon Hà Nội",
    sub: "Gợi ý địa điểm chất lượng quanh bạn, cập nhật liên tục.",
  },
  {
    key: "s2",
    image: require("../../../assets/onboarding/intro-2.png"),
    text: "📜 Menu minh bạch, rõ ràng",
    sub: "Xem giá, hình ảnh món ăn và đánh giá thực tế.",
  },
  {
    key: "s3",
    image: require("../../../assets/onboarding/intro-3.png"),
    text: "⭐ Đánh dấu & chia sẻ",
    sub: "Lưu quán yêu thích và để lại bình luận hữu ích.",
  },
];
            ...
            <Pressable onPress={onNext}>
              ...
              >
                <Text color="#fff" fontSize={15} fontWeight={800}>
                  {page === SLIDES.length - 1 ? "Bắt đầu" : "Tiếp"}
                </Text>
              </Box>
            </Pressable>
          </HStack>
